...
public:
    ...
    bool OnPlayerCanUseChat(Player* player, uint32 type, uint32 /*lang*/, std::string& msg, [[maybe_unused]] Guild* guild) override
    {
...
public:
    ...
    void OnPlayerbotUpdate([[maybe_unused]] uint32 diff) override
    {
