...
bool UseItemAction::Execute([[maybe_unused]] Event event)
{
...
bool UseHearthStone::Execute([[maybe_unused]] Event event)
{
    if (bot->isMoving())
    {
...
bool UseRandomRecipe::Execute([[maybe_unused]] Event event)
{
...
bool UseRandomQuestItem::Execute([[maybe_unused]] Event event)
{
