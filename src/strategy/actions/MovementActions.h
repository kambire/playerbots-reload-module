...
protected:
    ...
    bool MoveTo(uint32 mapId, float x, float y, float z, [[maybe_unused]] bool idle = false,
                [[maybe_unused]] bool react = false,
    ...
    bool ChaseTo(WorldObject* obj, float distance = 0.0f, [[maybe_unused]] float angle = 0.0f);
    ...
    bool IsMovingAllowed([[maybe_unused]] uint32 mapId, [[maybe_unused]] float x, [[maybe_unused]] float y,
                         [[maybe_unused]] float z);
    bool IsDuplicateMove([[maybe_unused]] uint32 mapId, float x, float y, float z);
...
public:
    ...
    virtual bool Execute([[maybe_unused]] Event event);
