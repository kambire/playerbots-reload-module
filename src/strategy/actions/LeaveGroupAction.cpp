...
bool LeaveGroupAction::Execute([[maybe_unused]] Event event)
{
...
bool PartyCommandAction::Execute([[maybe_unused]] Event event)
{
...
bool UninviteAction::Execute([[maybe_unused]] Event event)
{
    WorldPacket& p = event.getPacket();
