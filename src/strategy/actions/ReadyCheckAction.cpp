...
{
public:
    bool Check([[maybe_unused]] PlayerbotAI* botAI, [[maybe_unused]] AiObjectContext* context) override
    {
...
{
public:
    bool Check(PlayerbotAI* botAI, [[maybe_unused]] AiObjectContext* context) override
    {
...
bool ReadyCheckAction::Execute([[maybe_unused]] Event event)
{
