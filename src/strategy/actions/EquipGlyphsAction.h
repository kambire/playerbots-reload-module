...
public:
    ...
    /// ---- Rendu public pour Ãªtre utilisable par le cache global ----
    struct GlyphInfo
    {
        GlyphPropertiesEntry const* prop;   ///< entrÃ©e GlyphProperties.dbc
        ItemTemplate const*         proto;  ///< template de lâ€™objet glyphe
    };
...
private:
    ...
    /// Parse & valide la liste dâ€™items glyphes
