...
Player* GuidManageAction::GetPlayer([[maybe_unused]] Event event)
{
...
bool GuidManageAction::Execute([[maybe_unused]] Event event)
{
...
bool GuildLeaveAction::Execute([[maybe_unused]] Event event)
{
