...
bool InviteNearbyToGroupAction::Execute([[maybe_unused]] Event event)
{
...
bool JoinGroupAction::Execute([[maybe_unused]] Event event)
{
    if (bot->InBattleground())
        return false;
...
bool LfgAction::Execute([[maybe_unused]] Event event)
{
