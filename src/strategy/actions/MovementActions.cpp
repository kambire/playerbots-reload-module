...
bool MovementAction::MoveTo(uint32 mapId, float x, float y, float z, [[maybe_unused]] bool idle,
                            [[maybe_unused]] bool react, bool normal_only,
...
bool MovementAction::IsMovingAllowed([[maybe_unused]] uint32 mapId, [[maybe_unused]] float x, [[maybe_unused]] float y,
...
bool RunAwayAction::Execute([[maybe_unused]] Event event) { return Flee(AI_VALUE(Unit*, "group leader")); }
