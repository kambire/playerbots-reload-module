...
Creature* SeeSpellAction::CreateWps(Player* wpOwner, float x, float y, float z, float o, uint32 entry,
                                    [[maybe_unused]] Creature* lastWp, bool important)
{
...
bool SeeSpellAction::Execute([[maybe_unused]] Event event)
{
    // RTSC packet data
