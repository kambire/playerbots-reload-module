...
public:
    ...
    virtual std::string const castString([[maybe_unused]] WorldObject* target) { return "cast"; }
...
public:
    ...
    virtual uint32 GetSpellPriority([[maybe_unused]] SpellInfo const* spellInfo) { return 1; }
