...
void ReleaseSpiritAction::LogRelease(const std::string& releaseMsg, [[maybe_unused]] bool isAutoRelease) const
{
...
bool SelfResurrectAction::Execute([[maybe_unused]] Event event)
{
