...
bool ChangeCombatStrategyAction::Execute([[maybe_unused]] Event event)
{
...
bool ChangeNonCombatStrategyAction::Execute([[maybe_unused]] Event event)
{
    std::string const text = event.getParam();
...
bool ChangeDeadStrategyAction::Execute([[maybe_unused]] Event event)
{
    std::string const text = event.getParam();
