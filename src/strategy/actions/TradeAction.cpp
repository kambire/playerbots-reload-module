...
bool TradeAction::Execute([[maybe_unused]] Event event)
{
    ...
    int countInt = pos != std::string::npos ? atoi(text.substr(pos + 1).c_str()) : 1;
    uint32 count = countInt > 0 ? static_cast<uint32>(countInt) : 1u;
