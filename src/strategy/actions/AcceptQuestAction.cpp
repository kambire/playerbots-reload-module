...
bool AcceptQuestAction::Execute([[maybe_unused]] Event event)
{
...
bool AcceptQuestShareAction::Execute([[maybe_unused]] Event event)
{
...
bool ConfirmQuestAction::Execute([[maybe_unused]] Event event)
{
    Player* bot = botAI->GetBot();
    Player* requester = event.getOwner() ? event.getOwner() : GetMaster();
