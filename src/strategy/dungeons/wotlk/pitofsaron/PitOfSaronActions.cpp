...
bool IckAndKrickAction::Execute([[maybe_unused]] Event event)
{
    ...
    bool explosiveBarrage =
        orb || (boss->HasUnitState(UNIT_STATE_CASTING) &&
...
bool IckAndKrickAction::ExplosiveBarrage([[maybe_unused]] bool explosiveBarrage, Unit* boss)
{
    std::vector<Unit*> orbs;
...
bool TyrannusAction::Execute([[maybe_unused]] Event event)
{
