...
bool CorpseExplodeSpreadAction::Execute([[maybe_unused]] Event event)
{
...
bool AvoidArcaneFieldAction::Execute([[maybe_unused]] Event event)
{
...
bool NovosDefaultPositionAction::Execute([[maybe_unused]] Event event)
{
...
bool NovosTargetPriorityAction::Execute([[maybe_unused]] Event event)
{
