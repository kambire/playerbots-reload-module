...
bool FeedPetAction::Execute([[maybe_unused]] Event event)
{
...
bool CastDisengageAction::Execute([[maybe_unused]] Event event)
{
...
bool CastScareBeastCcAction::Execute([[maybe_unused]] Event event) { return botAI->CastSpell("scare beast", GetTarget()); }
