...
// Lord Marrowgwar
bool IccLmTankPositionAction::Execute([[maybe_unused]] Event event)
{
...
bool IccSpikeAction::Execute([[maybe_unused]] Event event)
{
...
// Lady Deathwhisper
bool IccDarkReckoningAction::Execute([[maybe_unused]] Event event)
{
...
bool IccRangedPositionLadyDeathwhisperAction::Execute([[maybe_unused]] Event event)
{
...
bool IccAddsLadyDeathwhisperAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "lady deathwhisper");
    if (!boss)
        return false;
...
bool IccShadeLadyDeathwhisperAction::Execute([[maybe_unused]] Event event)
{
...
bool IccRottingFrostGiantTankPositionAction::Execute([[maybe_unused]] Event event)
{
...
bool IccGunshipTeleportAllyAction::Execute([[maybe_unused]] Event event)
{
...
bool IccGunshipTeleportHordeAction::Execute([[maybe_unused]] Event event)
{
    static constexpr float MAX_WAITING_DISTANCE = 45.0f;
    static constexpr float MAX_ATTACK_DISTANCE = 15.0f;
    static constexpr uint8_t SKULL_ICON_INDEX = 7;
...
//DBS
bool IccDbsTankPositionAction::Execute([[maybe_unused]] Event event)
{
...
bool IccAddsDbsAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "deathbringer saurfang");
    if (!boss)
        return false;
...
// Festergut
bool IccFestergutGroupPositionAction::Execute([[maybe_unused]] Event event)
{
...
bool IccFestergutSporeAction::Execute([[maybe_unused]] Event event)
{
...
// Rotface
bool IccRotfaceTankPositionAction::Execute([[maybe_unused]] Event event)
{
...
bool IccRotfaceGroupPositionAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "rotface");
    if (!boss)
        return false;
...
bool IccRotfaceMoveAwayFromExplosionAction::Execute([[maybe_unused]] Event event)
{
...
// Proffesor Putricide
bool IccPutricideGrowingOozePuddleAction::Execute([[maybe_unused]] Event event)
{
...
bool IccPutricideVolatileOozeAction::Execute([[maybe_unused]] Event event)
{
...
bool IccPutricideGasCloudAction::Execute([[maybe_unused]] Event event)
{
...
bool IccPutricideAvoidMalleableGooAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "professor putricide");
    if (!boss)
        return false;
...
// BPC
bool IccBpcKelesethTankAction::Execute([[maybe_unused]] Event event)
{
    if (!botAI->IsAssistTank(bot))
        return false;
...
bool IccBpcMainTankAction::Execute([[maybe_unused]] Event event)
{
...
bool IccBpcEmpoweredVortexAction::Execute([[maybe_unused]] Event event)
{
...
bool IccBpcKineticBombAction::Execute([[maybe_unused]] Event event)
{
...
bool IccBpcBallOfFlameAction::Execute([[maybe_unused]] Event event)
{
...
bool IccBqlGroupPositionAction::Execute([[maybe_unused]] Event event)
{
...
bool IccBqlPactOfDarkfallenAction::Execute([[maybe_unused]] Event event)
{
...
bool IccBqlVampiricBiteAction::Execute([[maybe_unused]] Event event)
{
...
// Sister Svalna
bool IccValkyreSpearAction::Execute([[maybe_unused]] Event event)
{
...
bool IccSisterSvalnaAction::Execute([[maybe_unused]] Event event)
{
...
// VDW
bool IccValithriaGroupAction::Execute([[maybe_unused]] Event event)
{
...
bool IccValithriaPortalAction::Execute([[maybe_unused]] Event event)
{
...
bool IccValithriaHealAction::Execute([[maybe_unused]] Event event)
{
...
bool IccValithriaDreamCloudAction::Execute([[maybe_unused]] Event event)
{
...
// Sindragosa
bool IccSindragosaGroupPositionAction::Execute([[maybe_unused]] Event event)
{
...
bool IccSindragosaTankSwapPositionAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "sindragosa");
    if (!boss)
        return false;
...
bool IccSindragosaFrostBeaconAction::Execute([[maybe_unused]] Event event)
{
...
bool IccSindragosaBlisteringColdAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "sindragosa");
    if (!boss)
        return false;
...
bool IccSindragosaUnchainedMagicAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "sindragosa");
    if (!boss)
        return false;
...
bool IccSindragosaChilledToTheBoneAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "sindragosa");
    if (!boss)
        return false;
...
bool IccSindragosaMysticBuffetAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "sindragosa");
...
bool IccSindragosaFrostBombAction::Execute([[maybe_unused]] Event event)
{
...
// The Lich King
bool IccLichKingShadowTrapAction::Execute([[maybe_unused]] Event event)
{
...
bool IccLichKingNecroticPlagueAction::Execute([[maybe_unused]] Event event)
{
...
bool IccLichKingWinterAction::Execute([[maybe_unused]] Event event)
{
    Unit* boss = AI_VALUE2(Unit*, "find target", "the lich king");
    if (!boss)
        return false;
...
bool IccLichKingAddsAction::Execute([[maybe_unused]] Event event)
{
