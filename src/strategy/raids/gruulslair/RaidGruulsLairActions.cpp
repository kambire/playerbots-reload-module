...
bool HighKingMaulgarMainTankAttackMaulgarAction::Execute([[maybe_unused]] Event event)
{
...
bool HighKingMaulgarFirstAssistTankAttackOlmAction::Execute([[maybe_unused]] Event event)
{
...
bool HighKingMaulgarSecondAssistTankAttackBlindeyeAction::Execute([[maybe_unused]] Event event)
{
...
bool HighKingMaulgarMageTankAttackKroshAction::Execute([[maybe_unused]] Event event)
{
...
bool HighKingMaulgarMoonkinTankAttackKigglerAction::Execute([[maybe_unused]] Event event)
{
...
bool HighKingMaulgarAssignDPSPriorityAction::Execute([[maybe_unused]] Event event)
{
...
bool HighKingMaulgarHealerFindSafePositionAction::Execute([[maybe_unused]] Event event)
{
...
bool HighKingMaulgarRunAwayFromWhirlwindAction::Execute([[maybe_unused]] Event event)
{
    Unit* maulgar = AI_VALUE2(Unit*, "find target", "high king maulgar");
...
bool HighKingMaulgarBanishFelstalkerAction::Execute([[maybe_unused]] Event event)
{
...
bool HighKingMaulgarMisdirectOlmAndBlindeyeAction::Execute([[maybe_unused]] Event event)
{
    Group* group = bot->GetGroup();
    if (!group)
        return false;
...
bool GruulTheDragonkillerMainTankPositionBossAction::Execute([[maybe_unused]] Event event)
{
...
bool GruulTheDragonkillerSpreadRangedAction::Execute([[maybe_unused]] Event event)
{
    Group* group = bot->GetGroup();
    if (!group)
        return false;
...
bool GruulTheDragonkillerShatterSpreadAction::Execute([[maybe_unused]] Event event)
{
    Group* group = bot->GetGroup();
    if (!group)
        return false;
