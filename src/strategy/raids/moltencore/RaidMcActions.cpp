...
bool McMoveFromGroupAction::Execute([[maybe_unused]] Event event)
{
...
bool McShazzrahMoveAwayAction::Execute([[maybe_unused]] Event event)
{
...
bool McGolemaggMarkBossAction::Execute([[maybe_unused]] Event event)
{
...
bool McGolemaggMainTankAttackGolemaggAction::Execute([[maybe_unused]] Event event)
{
...
bool McGolemaggAssistTankAttackCoreRagerAction::Execute([[maybe_unused]] Event event)
{
