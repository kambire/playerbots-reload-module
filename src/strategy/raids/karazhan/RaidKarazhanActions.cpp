...
bool ManaWarpStunCreatureBeforeWarpBreachAction::Execute([[maybe_unused]] Event event)
{
...
bool AttumenTheHuntsmanMarkTargetAction::Execute([[maybe_unused]] Event event)
{
...
bool AttumenTheHuntsmanSplitBossesAction::Execute([[maybe_unused]] Event event)
{
...
bool AttumenTheHuntsmanStackBehindAction::Execute([[maybe_unused]] Event event)
{
    Unit* attumenMounted = GetFirstAliveUnitByEntry(botAI, NPC_ATTUMEN_THE_HUNTSMAN_MOUNTED);
    if (!attumenMounted)
        return false;
...
bool AttumenTheHuntsmanManageDpsTimerAction::Execute([[maybe_unused]] Event event)
{
    Unit* midnight = AI_VALUE2(Unit*, "find target", "midnight");
    if (!midnight)
        return false;
...
bool MoroesMainTankAttackBossAction::Execute([[maybe_unused]] Event event)
{
...
bool MoroesMarkTargetAction::Execute([[maybe_unused]] Event event)
{
...
bool MaidenOfVirtueMoveBossToHealerAction::Execute([[maybe_unused]] Event event)
{
...
bool MaidenOfVirtuePositionRangedAction::Execute([[maybe_unused]] Event event)
{
...
bool BigBadWolfPositionBossAction::Execute([[maybe_unused]] Event event)
{
...
bool BigBadWolfRunAwayFromBossAction::Execute([[maybe_unused]] Event event)
{
...
bool RomuloAndJulianneMarkTargetAction::Execute([[maybe_unused]] Event event)
{
...
// Mark targets with skull in the recommended kill order
bool WizardOfOzMarkTargetAction::Execute([[maybe_unused]] Event event)
{
...
bool WizardOfOzScorchStrawmanAction::Execute([[maybe_unused]] Event event)
{
    Unit* strawman = AI_VALUE2(Unit*, "find target", "strawman");
...
bool TheCuratorMarkAstralFlareAction::Execute([[maybe_unused]] Event event)
{
...
bool TheCuratorPositionBossAction::Execute([[maybe_unused]] Event event)
{
...
bool TheCuratorSpreadRangedAction::Execute([[maybe_unused]] Event event)
{
...
bool TerestianIllhoofMarkTargetAction::Execute([[maybe_unused]] Event event)
{
...
bool ShadeOfAranRunAwayFromArcaneExplosionAction::Execute([[maybe_unused]] Event event)
{
...
bool ShadeOfAranStopMovingDuringFlameWreathAction::Execute([[maybe_unused]] Event event)
{
...
bool ShadeOfAranMarkConjuredElementalAction::Execute([[maybe_unused]] Event event)
{
...
bool ShadeOfAranRangedMaintainDistanceAction::Execute([[maybe_unused]] Event event)
{
    Unit* aran = AI_VALUE2(Unit*, "find target", "shade of aran");
    if (!aran)
        return false;
...
bool NetherspiteBlockRedBeamAction::Execute([[maybe_unused]] Event event)
{
...
bool NetherspiteBlockBlueBeamAction::Execute([[maybe_unused]] Event event)
{
    Unit* netherspite = AI_VALUE2(Unit*, "find target", "netherspite");
    if (!netherspite)
        return false;
...
// When avoiding void zones, blocking bots will move along the beam to continue blocking
bool NetherspiteBlockGreenBeamAction::Execute([[maybe_unused]] Event event)
{
    Unit* netherspite = AI_VALUE2(Unit*, "find target", "netherspite");
    if (!netherspite)
        return false;
...
bool NetherspiteAvoidBeamAndVoidZoneAction::Execute([[maybe_unused]] Event event)
{
    Unit* netherspite = AI_VALUE2(Unit*, "find target", "netherspite");
    if (!netherspite)
        return false;
...
bool NetherspiteBanishPhaseAvoidVoidZoneAction::Execute([[maybe_unused]] Event event)
{
    std::vector<Unit*> voidZones = GetAllVoidZones(botAI, bot);
...
bool NetherspiteManageTimersAndTrackersAction::Execute([[maybe_unused]] Event event)
{
    Unit* netherspite = AI_VALUE2(Unit*, "find target", "netherspite");
    if (!netherspite)
        return false;
...
bool PrinceMalchezaarEnfeebledAvoidHazardAction::Execute([[maybe_unused]] Event event)
{
...
bool PrinceMalchezaarNonTankAvoidInfernalAction::Execute([[maybe_unused]] Event event)
{
    Unit* malchezaar = AI_VALUE2(Unit*, "find target", "prince malchezaar");
    if (!malchezaar)
        return false;
...
bool PrinceMalchezaarMainTankMovementAction::Execute([[maybe_unused]] Event event)
{
    Unit* malchezaar = AI_VALUE2(Unit*, "find target", "prince malchezaar");
    if (!malchezaar)
        return false;
...
bool NightbaneGroundPhasePositionBossAction::Execute([[maybe_unused]] Event event)
{
...
bool NightbaneGroundPhaseRotateRangedPositionsAction::Execute([[maybe_unused]] Event event)
{
    const ObjectGuid botGuid = bot->GetGUID();
...
bool NightbaneCastFearWardOnMainTankAction::Execute([[maybe_unused]] Event event)
{
...
bool NightbaneControlPetAggressionAction::Execute([[maybe_unused]] Event event)
{
    Unit* nightbane = AI_VALUE2(Unit*, "find target", "nightbane");
    if (!nightbane)
        return false;
...
bool NightbaneFlightPhaseMovementAction::Execute([[maybe_unused]] Event event)
{
    Unit* nightbane = AI_VALUE2(Unit*, "find target", "nightbane");
...
bool NightbaneManageTimersAndTrackersAction::Execute([[maybe_unused]] Event event)
{
    Unit* nightbane = AI_VALUE2(Unit*, "find target", "nightbane");
    if (!nightbane)
        return false;
