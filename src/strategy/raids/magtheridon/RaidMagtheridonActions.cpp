...
bool MagtheridonMainTankAttackFirstThreeChannelersAction::Execute([[maybe_unused]] Event event)
{
...
bool MagtheridonFirstAssistTankAttackNWChannelerAction::Execute([[maybe_unused]] Event event)
{
...
bool MagtheridonSecondAssistTankAttackNEChannelerAction::Execute([[maybe_unused]] Event event)
{
...
bool MagtheridonMisdirectHellfireChannelers::Execute([[maybe_unused]] Event event)
{
...
bool MagtheridonAssignDPSPriorityAction::Execute([[maybe_unused]] Event event)
{
...
bool MagtheridonWarlockCCBurningAbyssalAction::Execute([[maybe_unused]] Event event)
{
    Group* group = bot->GetGroup();
    if (!group)
        return false;
...
bool MagtheridonMainTankPositionBossAction::Execute([[maybe_unused]] Event event)
{
    Unit* magtheridon = AI_VALUE2(Unit*, "find target", "magtheridon");
    if (!magtheridon)
        return false;
...
bool MagtheridonSpreadRangedAction::Execute([[maybe_unused]] Event event)
{
    Unit* magtheridon = AI_VALUE2(Unit*, "find target", "magtheridon");
    if (!magtheridon)
        return false;
...
bool MagtheridonUseManticronCubeAction::Execute([[maybe_unused]] Event event)
{
    Unit* magtheridon = AI_VALUE2(Unit*, "find target", "magtheridon");
    if (!magtheridon)
        return false;
...
bool MagtheridonManageTimersAndAssignmentsAction::Execute([[maybe_unused]] Event event)
{
    Unit* magtheridon = AI_VALUE2(Unit*, "find target", "magtheridon");
    if (!magtheridon)
        return false;
